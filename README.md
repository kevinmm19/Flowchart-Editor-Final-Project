...
<center>
### Documentación de Aplicación III Etapa
</center>
...
La presente documentación se refiere a la tercera etapa del proyecto, la cual incluye la funcionalidad completa del editor de diagramas de flujo asignado, además de los cambios hechos en el diseño del mismo.
 
La implementación del editor se hizo de forma dinámica para esta tercera etapa del proyecto, por lo que se muestra  las funcionalidades principales del editor, incorporando interacciones. Las funcionalidades principales del editor consisten en la carga, despliegue, edición y guardado de diagramas de flujo en disco así como la creación de diagramas flujo desde la misma aplicación.
...
Para esta etapa se incluyen además cambios en el diseño de la interfaz, los cuales consisten en: cambiar el tema de la interfaz, agregar una barra de botones y una ayuda.

Finalmente, se presentarán las conclusiones de la tercera etapa del proyecto las cuales estarán basadas en las limitaciones observadas y posibles mejoras (lista TO DO) de la aplicación.
...
Para esta entrega el editor cuenta con varios cambios en su diseño, los cuales consisten en el cambio de apariencia por medio del uso de temas nuevos en la aplicación, cambios en la barra de botones previamente diseñada y además se incluye la opción de una ayuda dentro de la 
misma . Los temas utilizados sobre la aplicación son los siguientes:
...
Finalmente se le agregó una opción de ayuda la cual muestra el siguiente texto.
...
Las limitaciones encontradas para esta tercera etapa del proyecto fueron pocas con respecto a las etapas pasadas, pues el ambiente híbrido de Bootstrap, Adobe Air y Javascript no resultó muy díficil de utilizar pero si se tuvieron ciertos problemas al tratar de implementar el empaquetamiento o la ejecución de la aplicación en Adobe Air. A continuación se presentan las limitaciones observadas y posibles mejoras:
 ...
 * A partir de constantes pruebas se determina que los diagramas de flujo pueden realizarse sin problemas, pues la implementación de los diagramas a partir de los archivos XML de prueba fue exitosa, pero esto es solo factible en HTML pues en Adobe Air se generan errores al utilizar la librería de Jointjs.
 ...
 * La implementación de distintos temas a la aplicación fue exitosa, ya que los cambios que se requerían para adaptar los distintos temas a la aplicación eran minimos o innecesarios, por lo que se pudo alcanzar un mayor grado de elegancia de aplicación en esta tercera etapa.
